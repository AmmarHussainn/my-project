...
const FrontSection = () => {
    ...
    function redirectToWhatsApp() {
        const phoneNumber = '+923196999504';
        const message = encodeURIComponent('Hello,I saw ur portfolio , I want to send you a message!');
        const whatsappURL = `https://wa.me/${phoneNumber}?text=${message}`;
        window.open(whatsappURL, '_blank');
    }
    function redirectToLinkedIn() {
        const linkedInURL = 'https://www.linkedin.com/in/ammar-hussain-2a0025184/';
        window.open(linkedInURL, '_blank');
    }
    function redirectToGitHub() {
        const linkedInURL = 'https://github.com/AmmarHussainn';
        window.open(linkedInURL, '_blank');
    }
    function redirectToEmail() {
        const email = 'ammarhussain0315@gmail.com';
